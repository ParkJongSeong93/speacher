      ...
      <div className="w-full h-screen flex flex-col">
        ...
        <div className="flex w-full flex-1">
          <div className="bg-uploadBg-gray flex flex-col justify-center w-1/4">
            ...
            <div className="py-4 pl-3 mb-10 bg-uploadPageBtn-gray">+ New Video</div>
            <div className="py-4 pl-3 mb-6 bg-uploadPageBtn-lightgray text-gray-400">- list</div>
            <div className="py-4 pl-3 mb-6 bg-uploadPageBtn-lightgray text-gray-400">- list</div>
            <div className="py-4 pl-3 mb-14 bg-uploadPageBtn-lightgray text-gray-400">- list</div>
            <div className="py-4 pl-3 mb-6 bg-uploadPageBtn-lightgray">Option</div>
